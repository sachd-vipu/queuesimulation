...
const KnowledgeBase: React.FC = () => {
  ...
  const sections: Sections = {
    intro: {
      ...
      content: 'Queueing theory is a mathematical study of waiting lines, or queues. It analyzes the behavior of systems where customers arrive, wait for service, and depart after being served. The theory helps predict queue lengths, waiting times, and system performance under various conditions.'
    },
    notation: {
